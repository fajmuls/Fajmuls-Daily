      ...
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          ...
          <p className="text-stone-500 text-lg mt-2 font-medium">
            Lacak pemasukan dan pengeluaran harianmu.
          </p>
        </div>
        <div className="flex gap-2">
          <button
            ...
            className="p-3 bg-blue-50 text-blue-600 rounded-2xl hover:bg-blue-100 transition-all font-bold text-sm tracking-tight"
          >
            Ekspor Akun Workspace
          </button>
          <button
            onClick={() => {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-stone-900 text-white rounded-3xl p-8 shadow-xl relative overflow-hidden group">
            ...
            <div className="flex justify-between items-start mb-2 relative z-10">
              ...
              <button
                ...
                className="text-stone-900 bg-white hover:bg-stone-50 transition-colors p-2 rounded-xl shadow-sm flex items-center gap-1.5 font-bold"
              >
                {hideAmounts ? (
                ...
                <span className="text-xs">
                  {hideAmounts ? "Tampilkan" : "Sembunyi"}
                </span>
              </button>
            </div>
            ...
            <div className="grid grid-cols-1 gap-4 border-t border-white/10 pt-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-stone-500 text-[10px] uppercase tracking-widest font-bold mb-1">
                    Total Pendapatan
                  </p>
          ...
          <form
            ...
            className="bg-paper rounded-3xl p-6 border border-stone-200 shadow-sm space-y-4"
          >
            ...
            <div>
              <label className="block text-xs uppercase tracking-wide text-stone-500 font-bold mb-2">
                Jumlah
              </label>
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full bg-stone-50 rounded-xl pl-12 pr-4 py-3 outline-none focus:ring-2 focus:ring-stone-900 font-mono text-lg"
                  placeholder="0"
                />
              </div>
            </div>
            ...
            <div className="relative">
              <label className="block text-xs uppercase tracking-wide text-stone-500 font-bold mb-2 font-sans">
                Kategori (Otomatis Grup)
              </label>
              <div className="relative">
                <input
                  type="text"
              ...
              {showCatDropdown && (
                <div className="absolute top-full left-0 right-0 mt-2 bg-white border border-stone-200 rounded-xl shadow-lg z-20 max-h-48 overflow-y-auto overflow-x-hidden p-2 grid grid-cols-2 gap-1 animate-in fade-in slide-in-from-top-2">
                    ...
                    .map((cat, i) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {group && (
                            <span className="text-[8px] text-stone-400 uppercase tracking-tighter pl-3.5">
                              Grup: {group}
                            </span>
                          )}
                        </button>
                  ...
                  {categorySuggestions.filter((c) =>
                    ...
                    <div className="col-span-2 text-center py-4 text-[10px] text-stone-400">
                      Ketik untuk membuat baru "{category}"
                    </div>
                  )}
                </div>
              )}
            ...
            <button
              type="submit"
              className="w-full bg-stone-900 text-white rounded-xl py-4 font-bold mt-2 hover:bg-stone-800 active:scale-[0.98] transition-all flex items-center justify-center gap-2"
            >
                          ...
                          >
                            {incomeData.map((_entry, index) => (
                              <Cell
                                key={`cell-${index}`}
                                fill={
                                  COLORS_INCOME[index % COLORS_INCOME.length]
                                }
                  ...
                  .map((groupName) => {
                    ...
                    return (
                      <div key={groupName} className="p-6">
                        <h4 className="font-bold font-serif text-lg text-stone-800 mb-4">
                          {groupName}
                        </h4>
                          ...
                          {groupRecords.map((record) => (
                            ...
                            >
                              ...
                              <div className="flex items-center gap-3 shrink-0 pl-2">
                                <span
                                  className={cn(
                                    "font-bold text-sm font-sans tracking-tight whitespace-nowrap",
                                    record.type === "income"
                                      ? "text-green-600"
                                      : "text-stone-900",
                                  )}
                                ...
                                <button
                                  ...
                                  className="p-2 text-stone-300 hover:text-red-500 transition-colors rounded-full hover:bg-red-50 md:opacity-0 md:group-hover:opacity-100 shrink-0"
                                >
                ...
                {filteredRecords.map((record) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-4 min-w-0">
                      ...
                      <div className="min-w-0 flex flex-col">
                        ...
                        <p className="text-xs text-stone-400 mt-0.5">
                          {format(record.createdAt, "d MMM yyyy - HH:mm", {
                            locale: id,
                          })}
                        </p>
                        {record.note && (
                    ...
                    <div className="flex items-center gap-4 shrink-0">
                      <span
                        className={cn(
                          "font-bold text-sm md:text-lg font-sans tracking-tight whitespace-nowrap",
                          record.type === "income"
                            ? "text-green-600"
                            : "text-stone-900",
                        )}
            ...
            >
              ...
              <div className="p-6 overflow-y-auto flex-1 space-y-6">
                <div className="bg-stone-50 p-4 rounded-2xl border border-stone-200">
                  <h4 className="font-bold text-xs uppercase tracking-widest text-stone-500 mb-4">
                    ...
                    <div className="space-y-1 relative">
                      ...
                      <div className="relative">
                        ...
                        <button
                          ...
                          onClick={(e) => {
                            e.stopPropagation();
                            setShowNewCatDropdown(!showNewCatDropdown);
                          }}
                      ...
                      {showNewCatDropdown && (
                        <>
                          <div
                            ...
                            onClick={() => setShowNewCatDropdown(false)}
                          />
                          <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-stone-200 rounded-xl shadow-xl z-50 max-h-40 overflow-y-auto p-1.5 flex flex-col gap-1">
                            {allCategories
                              .filter((c) =>
                                c
                                  .toLowerCase()
                                  .includes(newGroupCategory.toLowerCase()),
                              )
                              .map((cat, idx) => (
                                <button
                                  key={idx}
                            ...
                            {allCategories.filter((c) =>
                              ...
                              <div className="p-3 text-[10px] text-stone-400 italic text-center">
                    ...
                    <div className="space-y-1 relative">
                      ...
                      <div className="relative">
                        ...
                        <button
                          ...
                          onClick={(e) => {
                            e.stopPropagation();
                            setShowNewGroupDropdown(!showNewGroupDropdown);
                          }}
                          className="absolute right-2 top-1/2 -translate-y-1/2 p-1 text-stone-400 hover:text-stone-600"
                        >
                          <ChevronDown
                            className={cn(
                              "w-3.5 h-3.5 transition-transform",
                              showNewGroupDropdown ? "rotate-180" : "",
                            )}
                          />
                        </button>
                      </div>
                      {showNewGroupDropdown && (
                        <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-stone-200 rounded-xl shadow-xl z-50 max-h-40 overflow-y-auto p-1.5 flex flex-col gap-1">
                          ...
                          <div className="p-2 border-t border-stone-50 text-[10px] text-stone-400 italic text-center">
                            "{newGroupName}" (Tekan Enter untuk baru)
                          </div>
                        </div>
                      )}
                    </div>
                ...
                <div>
                  <h4 className="font-bold text-xs uppercase tracking-widest text-stone-500 mb-3 px-2">
                    Daftar Pemetaan Saat Ini
                  </h4>
                  {Object.keys(financeMappings).length === 0 ? (
                    <div className="text-center py-8 text-stone-400 text-sm italic">
                      Belum ada pemetaan. Buat grup untuk menampilkan data
                      terpusat di chart.
                    </div>
                  ) : (
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                      {Object.entries(financeMappings).map(([cat, group]) => (
                        <div
                          key={cat}
                          className="bg-white border border-stone-200 rounded-xl p-3 flex items-center justify-between group"
                        >
                          <div className="truncate">
                            <p className="font-bold text-xs text-stone-700 truncate">
                              {cat}
                            </p>
                            <p className="text-[10px] text-accent-orange font-bold uppercase trekking-widest">
                              {group}
                            </p>
                          </div>
                          <button
              ...
              <div className="p-6 bg-stone-50 border-t border-stone-100 text-center">
                <p className="text-[10px] text-stone-400 font-medium italic">
                  Pemetaan ini akan digunakan untuk mengelompokkan kategori pada
                  chart "Mode Grup".
                </p>
              </div>
            </motion.div>
